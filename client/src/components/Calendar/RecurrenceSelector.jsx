...
const RecurrenceSelector = ({ 
  ...
  const [endType, setEndType] = useState('never'); // 'never', 'on', 'count'
  ...
  const getFrequencyText = () => {
    ...
    return intervalText[frequency] || freq.label;
  };
        ...
        <div className={styles.content}>
          ...
          <div className={styles.preview}>
            ...
            <p className={styles.previewText}>
              {getFrequencyText()}{endType === 'on' && endDate ? ` до ${new Date(endDate).toLocaleDateString('ru-RU')}` : ''}
