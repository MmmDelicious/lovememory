...
const QuizGameNew_1 = require("./games/QuizGameNew");
const WordleGameNew_1 = require("./games/WordleGameNew");
const CodenamesGameNew_1 = require("./games/CodenamesGameNew");
const PokerGameNew_1 = require("./games/PokerGameNew");
/**
...
class GameManagerNew {
    ...
    _createQuizGameNew(roomId, players, options) {
        ...
        const game = new QuizGameNew_1.QuizGameNew(roomId, {
    ...
    _createWordleGameNew(roomId, players, options) {
        ...
        const game = new WordleGameNew_1.WordleGameNew(roomId, {
            gameFormat: gameFormat,
    ...
    _createPokerGameNew(roomId, players, options) {
        ...
        const game = new PokerGameNew_1.PokerGameNew(roomId, {
            smallBlind,
            bigBlind,
