 ...
 */
class QuizGameNew extends RealtimeGame_1.RealtimeGame {
    constructor(roomId, settings) {
        ...
        this._scores = {};
        this._playerAnswers = {};
        this._isCleanedUp = false; // Флаг для предотвращения запуска таймеров после очистки
    ...
    _allPlayersMoved() {
        const answeredPlayers = Object.keys(this._playerAnswers).filter(playerId => this._playerAnswers[playerId]?.[this._currentQuestionIndex] !== undefined);
...
//# sourceMappingURL=QuizGameNew.js.map