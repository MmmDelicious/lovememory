...
import { PokerSettings } from '../../types/poker.types';

export class PokerGameFactory {
  ...
  public static createGame(
    ...
    const game = new PokerEngine(gameId, settings);
   ...
   */
  public static createHeadsUpGame(
    gameId: string,
    player1: any,
    player2: any,
   ...
   */
  public static createTournamentGame(
    gameId: string,
    players: any[],
    options: any = {}
  ): PokerEngine {
