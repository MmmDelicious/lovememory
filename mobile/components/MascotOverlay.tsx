...
// Simple mascot overlay for RN (fallback without Lottie)
// Later can be swapped to lottie-react-native using an animation JSON
...
export default function MascotOverlay() {
  ...
  return (
    ...
    >
      <TouchableOpacity style={styles.avatar} onPress={() => setVisible(false)} activeOpacity={0.8}>
        {Platform.OS !== 'web' ? (
          // Lazy require to avoid web bundling the web entry of lottie-react-native
          // eslint-disable-next-line @typescript-eslint/no-var-requires
          (() => {
            const LottieView = require('lottie-react-native').default;
            const anim = require('../assets/mascots/ai.json');
